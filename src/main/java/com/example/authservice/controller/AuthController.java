...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest) {
        ...
        User user = authRepository.findByUsername(loginRequest.getUsername()).orElseThrow(() -> new UsernameNotFoundException("Пользователь не найден"));

        AuthResponse response = AuthResponse.builder().token(jwt).username(user.getUsername()).build();
